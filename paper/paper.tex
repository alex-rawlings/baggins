...
\title[BAGGinS]{Bayesian Analysis of Gas-free Galaxies in Simulations}
...
\begin{abstract}
We present the Bayesian Analysis of Gas-free Galaxies in Simulations (BAGGinS) project
\end{abstract}
