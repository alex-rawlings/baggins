...
cmapper, sm = bgs.plotting.create_normed_colours(1, 2, "crest")
...
plt.colorbar(sm, ax=ax3, label=r"$\gamma_0$")
bgs.plotting.savefig("core_relations.pdf", force_ext=True)
