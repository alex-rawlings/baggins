...
kfile = bgs.utils.get_ketjubhs_in_dir("/scratch/pjohanss/arawling/collisionless_merger/mergers/H-H-3.0-0.001/perturbations/002/output")
...
bh1, bh2, merged = bgs.analysis.get_bound_binary(kfile[0])
...
LL = bgs.mathematics.radial_separation(L)
period = 2*np.pi/orbit_pars["n"]/myr

hard_span, hard_idx = bgs.analysis.get_hard_timespan(orbit_pars["t"]/myr, hmq.semimajor_axis, hmq.time_of_snapshot, hmq.semimajor_axis_of_snapshot)
...
bgs.plotting.binary_param_plot(orbit_pars, ax)
