...
radial_masks = bgs.analysis.get_all_radial_masks(snap, 5, id_masks=id_masks)
...
bgs.plotting.savefig(os.path.join(bgs.FIGDIR, "stochasticity_ic.pdf"), fig=fig, force_ext=True)
plt.show()