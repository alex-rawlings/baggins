...
def bh_inset(ax, bounds, bhs, bh_num, stars):
    ...
    circle = Circle((bhs["pos"][bh_num, 0], bhs["pos"][bh_num, 2]), 2e-3, ec="w", fc="none", ls="--")
...
pidx = "009"
snapfile = f"/scratch/pjohanss/arawling/collisionless_merger/mergers/A-C-3.0-0.05/perturbations/{pidx}/output/AC_perturb_{pidx}_001.hdf5"
...
ax.set_facecolor("k")
ax.set_aspect("equal")
plot_kwargs = {"cbartitle":r"log$_{10}\Sigma$ [M$_\odot \mathrm{kpc}^{-2}$]", "Npx":800, "qty":"mass", "fontsize":10, "xaxis":0, "yaxis":2}
...
cmf.plotting.savefig(os.path.join(cmf.FIGDIR, "ketju.png"), fig=fig)
plt.show()