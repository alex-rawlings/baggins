...
snaplist = cmf.utils.get_snapshots_in_dir(main_path)
...
a_gr, a_gr_time = cmf.analysis.gravitational_radiation_radius(snap, r_infl, r_hard, r_hard_time, H, e=mean_e)
pq_estimates = TimeEstimates(orbit_params, r_hard_time_idx, a_more_Xpc, G_rho_per_sigma, H, K)
#peters_t, peters_a, peters_e = cmf.analysis.analytic_evolve_peters_quinlan(orbit_params, a_more_Xpc, H, K, G_rho_per_sigma)
