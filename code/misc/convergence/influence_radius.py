...
if False:
    ...
    for pfR, n in zip(("DE-030-0005r1.py", "DE-030-0005r2.py", "DE-030-0005r5.py"), ("1", "2", "5")):
        ...
        for i in range(11):
            ...
            for snapfile in snaplist:
                ...
                time_list.append(bgs.general.convert_gadget_time(snap))
                rinfl_list.append(
                    list(bgs.analysis.influence_radius(snap, binary=use_binary).values())[0].in_units_of("pc")
                )
                snap.delete_blocks()
            if i<10:
    ...
    bgs.utils.save_data(data, "influence_radius.pickle")
else:
    data = bgs.utils.load_data("influence_radius.pickle")
