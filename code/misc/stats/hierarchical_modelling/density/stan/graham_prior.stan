...
generated quantities {
    ...
    r_b = gamma_rng(r_b_a, r_b_b);     //1.0
    Re = gamma_rng(Re_a, Re_b);    //7.1
    I_b = gamma_rng(I_b_a, I_b_b) * 1e10;    //1.0e10
    g = gamma_rng(g_a, g_b);   //0.15
    n = gamma_rng(n_a, n_b);   // 3.1
