...
if isinstance(galaxy.stars, cmf.initialise.stellar_cuspy_ic) and isinstance(galaxy.dm, cmf.initialise.dm_halo_dehnen):
    dehnen_params_fitted = cmf.literature.fit_Dehnen_profile(radial_bin_centres['stars_dm'], radial_surf_dens['stars_dm'], total_stellar_mass + total_dm_mass + ic.bh['mass'])
    ax3.plot(radial_bin_centres['stars_dm'], cmf.literature.Dehnen(radial_bin_centres['stars_dm'], *dehnen_params_fitted, total_stellar_mass+total_dm_mass+ic.bh['mass']), color=fit_col[0], label=r'a:{:.1f}, $\gamma$:{:.1f}'.format(*dehnen_params_fitted))
