...
parser = argparse.ArgumentParser(
    description="Align a snapshot with either the semiminor axis of the reduced inertia tensor or angular momentum of the stars, and save the snapshot as a new file.",
    allow_abbrev=False,
)
...
parser.add_argument(
    ...
    "--orientate",
    type=str,
    help="how to orientate snapshot",
    dest="orientate",
    choices=["ri", "L"],
    default="ri",
)
parser.add_argument(
    ...
    "--normal",
    type=str,
    help="vector normal to merger plane",
    dest="normal",
    choices=["x", "y", "z"],
    default="y",
)
parser.add_argument(
    ...
    dest="plot",
    action="store_true",
    help="plot the snap before and after rotation",
)
parser.add_argument(
    "-v",
    "--verbose",
