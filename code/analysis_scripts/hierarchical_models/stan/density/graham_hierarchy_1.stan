...
transformed parameters {
    ...
    lprior[1] = normal_lpdf(log10_r_b_mean | 0.0, 0.7);
    lprior[2] = normal_lpdf(log10_r_b_std | -1.0, 0.1);
    lprior[3] = normal_lpdf(log10_Re_mean | 0.85, 0.6);
    lprior[4] = normal_lpdf(log10_Re_std | -1.0, 0.1);
    lprior[5] = normal_lpdf(log10_I_b_mean | 0.0, 0.7);
    lprior[6] = normal_lpdf(log10_I_b_std | -1.0, 0.1);
    lprior[7] = normal_lpdf(log10_g_mean | -0.5, 0.2);
    lprior[8] = normal_lpdf(log10_g_std | -1.0, 0.1);
    lprior[9] = normal_lpdf(log10_n_mean | 0.6, 0.4);
    lprior[10] = normal_lpdf(log10_n_std | -1.0, 0.1);
    lprior[11] = normal_lpdf(log10_a_mean | 1.0, 0.5);
    lprior[12] = normal_lpdf(log10_a_std | -0.5, 0.1);
