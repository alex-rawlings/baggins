...
class HMQuantitiesBinary(HMQuantitiesBinaryData, HMQuantitiesSingle):
    def __init__(self, parameter_file, merger_file, data_directory, merger_id) -> None:
        ...
        HMQuantitiesSingle().__init__(parameter_file, merger_file, data_directory, merger_id)
    ...
    def calculate(self):
        ...
        for snapfile in self.snaplist:
            ...
            try:
                ...
                self.hardening_radius.append(pygad.UnitScalar(np.nan, self.influence_radius[-1].units))
