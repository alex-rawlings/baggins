...
inset_window = 0.9
axins = ax.inset_axes([0.52, 0.03, 0.48, 0.48], xlim=(-inset_window, inset_window), ylim=(-inset_window-0.2, inset_window-0.2), xticklabels=[], yticklabels=[], xticks=[], yticks=[])
...
# add scale bar
bgs.plotting.draw_sizebar(axins, 0.5, "kpc", borderpad=0.25, remove_ticks=False, size_vertical=0.01)
