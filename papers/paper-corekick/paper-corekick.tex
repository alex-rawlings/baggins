...
\newcommand{\atte}[1]{{\color{teal}Atte: #1}}
\newcommand{\peter}[1]{{\color{purple}Peter: #1}}
\newcommand{\maxx}[1]{{\color{orange}Max: #1}}
\newcommand{\ruby}[1]{{\color{blue}Ruby: #1}}
\newcommand{\sonja}[1]{{\color{violet}Sonja: #1}}
...
\begin{abstract}
\alex{We have 250 words to use here. Currently 247 excluding the 3 math inlines.}

We study the contribution to stellar core growth in simulations of merging massive ($M_\star>10^9\,\Msun$) elliptical galaxies by a coalesced supermassive black hole (SMBH) displaced by gravitational wave (GW) induced recoil velocity.
With controlled, dense sampling of the SMBH recoil velocity, we find the stellar core originally formed by SMBH binary scouring can grow by a factor of 2-3 with increasing recoil velocity, and a similar growth in the central mass deficit.
...
An orbital decomposition of stellar particles within the core reveals that when the recoil velocity exceeds the velocity dispersion of the core, radial orbits dominate over tube orbits, providing a mass 10\% of the coalesced SMBH mass, whereas tube orbits dominate for the lowest recoil kicks.
A change in orbital structure is reflected in the anisotropy parameter, with a tangential bias present only for kick velocities less than the local stellar velocity dispersion.
With mock integral field unit observations of the stellar line of sight velocity distribution emulating the capabilities of current detectors, we observe a distinct signature in the Gauss-Hermite symmetric deviation coefficient $h_4$ that allows for an estimate of the core size due to binary scouring, irrespective of later evolution due to SMBH recoil.
Our results provide a method to estimate the SMBH recoil magnitude from observations of local elliptical galaxies, and implies these galaxies primarily experienced recoil velocities less than the stellar velocity dispersion of the core.
\end{abstract}
...
%As two galaxies dynamically interact during a galaxy merger, so too is it expected that the residing SMBHs will dynamically interact.
...
This is in clear tension with all current observations indicating that no massive elliptical galaxy in the local Universe is without an SMBH, and demands further investigation.
...
%This result is in tension with the work of \citet{gualandris2008}.

%The effect of recoiling SMBHs have been studied previously, with some of the first explorations presented in \citet{boylan2004} and \citet{merritt2004}.
%In the work of \citet{boylan2004}, a recoiling SMBH was found to induce a core in the stellar density profile, particularly when the SMBH remained bound to the bulge of the host galaxy and had a recoil velocity comparable to the bulge velocity dispersion.
%A recoiling SMBH was also found to induce a stellar density core in the work of \citet{merritt2004}.
%Additionally, the time for a recoiling SMBH to settle after being ejected in a spherical potential was found to be roughly one orbital period when the recoil velocity was less than the velocity dispersion of the bulge.
%This, which are more representative of a galaxy merger remnant than the spherical case.

%More recently, the contribution of stellar core expansion through GW recoil of an SMBH has been considered by \citet{nasim2021b}.
%Intriguingly, the authors find that greatest contribution to the stellar mass deficit is due to the first excursion of the SMBH following its ejection, with subsequent oscillations only providing a minor contribution to the growth of the stellar core.
%This result is in tension with the work of \citet{gualandris2008}.
...
%A recoiling SMBH was also found to induce a stellar density core in the work of \citet{merritt2004}.
%Additionally, the time for a recoiling SMBH to settle after being ejected in a spherical potential was found to be roughly one orbital period when the recoil velocity was less than the velocity dispersion of the bulge.
%This `infall time' was found to increase when considering triaxial potentials, which are more representative of a galaxy merger remnant than the spherical case.

%In \citet{gualandris2008}, a stellar potential representative of a galaxy merger remnant with SMBH binary core scouring is used to investigate the motion of an SMBH ejected through GW recoil.
%The motion of a settling SMBH was found to occur in three stages: first, the SMBH oscillates with decreasing amplitude due to energy dissipation by dynamical friction.
%Next, both the SMBH and stellar core oscillate about their common centre of mass when the radial excursion of the SMBH is less than the core radius of the stellar system.
%Finally, the SMBH settles into thermal equilibrium with the surrounding stars.
%During these three stages, the stellar density core is enhanced by the motion of the SMBH (in agreement with \citet{merritt2004} and \citet{boylan2004}), with the mass deficit in some cases reaching up to five times the SMBH mass being produced.

%Work by \citet{blecha2008} considered the effect of recoiling SMBHs in an analytical model of an isolated galaxy comprised of a multicomponent system of a stellar bulge and gaseous disc.
%An interesting result was the mass growth of the ejected SMBH as it settled at the centre of the potential, with the mass growth accumulating to some 10\% of the initial SMBH mass, irrespective of the recoil velocity.
%Recoiling SMBHs in gas-rich systems was further explored in \citet{blecha2011} using hydrodynamic simulations of isolated galaxy mergers.
%In this work, seed SMBHs were allowed to grow through gas accretion prior to merging, with the majority of final SMBH masses at the time of merger sampling the $10^7\,\Msun \lesssim M_\bullet \lesssim 10^8\,\Msun$ mass regime.



%The impact of recoiling SMBHs on the growth and dynamics of SMBHs in hydrodynamical simulations have also been studied using both isolated galaxy models consisting of a stellar bulge and a gaseous disc \citep{blecha2008}, as well as in isolated gas-rich galaxy mergers \citep{blecha2011}. %The study of the isolated galaxy model found that 
%the mass growth of the ejected SMBH as it settled at the centre of the potential, with the mass growth accumulating to some 10\% of the initial SMBH mass, irrespective of the recoil velocity. 
%In the merger simulations, the seed SMBHs were allowed to grow through gas accretion prior to merging, with the majority of the final SMBH masses at the time of merger sampling the $10^7\,\Msun \lesssim M_\bullet \lesssim 10^8\,\Msun$ mass regime. The simulations also showed that recoil events typically reduce the lifetimes of bright active galactic nuclei (AGNs), with most kicked AGNs confined to the central few kpc of the galaxy. Whilst the results of \citet{blecha2011} provide valuable insight into the occurrence of variable AGN variability due to an oscillating SMBH plunging through a gaseous disc, we stress that the results are applicable to a different mass regime of galaxies and SMBHs than what we focus on in this work. In addition, the formation of stellar cores which is primarily driven by complex three-body interactions between the SMBHs and the stellar component remains largely unresolved in simulations that include gravitational softening. 

Whilst previous studies have convincingly shown that there is a clear case for a relation between SMBH recoil velocity and the final core size carved out by its motion, little attention has been devoted to understanding the statistical impact of SMBH recoil on the properties of the merger remnant galaxy. 
Invoking large SMBH recoils as a mechanism to grow the most massive cores in elliptical galaxies \citep[e.g.][]{nasim2021b,khonji2024} has contributed an important piece to the overall puzzle of explaining current observations, however recoil velocities approaching the escape velocity of the host galaxy are unlikely to be the norm, given that all observed elliptical galaxies host a central SMBH \citep{ferrarese1994,haring2004,kormendy2013,vandenbosch2016}.
The role of mild SMBH recoil velocities remains largely unexplored.
...
%In this study, we wish to consider SMBH recoil by GW emission in massive elliptical galaxies.
%The aim of this work is twofold.
%We first aim to determine how the velocity with which the SMBH is kicked affects the mass distribution of the surrounding stellar environment, and the likelihood of the magnitude of these effects.
%We then aim to determine if a recoiling SMBH imparts a signature on the stellar kinematics of the remnant galaxy, and if such a signature could be observed with current detectors.
...
Finally, we discuss of our results in \autoref{sec:discussion} and present 
...
\ketju{} integrates the dynamics of SMBHs, and stellar particles in a small region thrice the stellar softening length around them (i.e. the \ketju{} region), to high accuracy using the algorithmically regularised integrator \textsc{mstar} \citep{rantala2020}.
...
Specifically, we ensure that our remnant agrees with the half-light -- stellar mass data presented in \citet{sahu2020}, and lies within the $1\sigma$ prediction interval of the SMBH mass -- stellar velocity dispersion data given in \citet{vandenbosch2016}.
...
For all simulations, snapshots are produced every $5\,\mathrm{Myr}$. Interactions between stellar particles are softened with a softening length of $\varepsilon = 2.5\,\mathrm{pc}$, DM with a softening length of $\varepsilon = 300\,\mathrm{pc}$, and the \ketju{} region radius is set to $r_{\rm ketju}=3\varepsilon = 7.5\,\mathrm{pc}$.
Within the \ketju{} region, dynamical interactions between stellar particles and SMBHs are unsoftened.
...
Before SMBH binary coalescence, the binary scours a stellar core with a radius of $\rbbin\sim0.58\,\mathrm{kpc}$ in the centre of the galaxy (see \autoref{ssec:projdens}). In the interior of the core, the stellar one-dimensional velocity dispersion is $\sigma_{\star,0} \equiv \sigma_\star(r<\rbbin)\sim 270\,\kmps$. 
...
\end{equation}
If the velocity of the recoil kick is not enough to completely eject the SMBH from the galaxy ($\vk < v_\mathrm{esc}$), the SMBH will oscillate about the centre of the galaxy. 
...
For the first few orbits, the SMBH may not necessarily pass through the stellar core, though it loses energy to the surrounding medium with each oscillation.
...
\end{equation}
where $\tilde{\sigma}$ is the average velocity dispersion of the stellar and DM particles, and $\xi$ is the mass ratio to the SMBH, determined:
\begin{equation}
...
The settling times are shown in the lower panel of \autoref{fig:infall}. For recoil velocities $\vk \leq 240\,\kmps$ the kick is not enough to displace the SMBH beyond the binary-scoured core and the SMBH is considered settled in less than $100\,\mathrm{Myr}$ after SMBH binary coalescence. 
...
We do however analyse the $\vk=2000\,\kmps$ simulation, which is above the escape velocity of the galaxy, as a proxy for an SMBH that is instantaneously removed from the simulation.
...
\begin{figure}
    ...
    \caption{ \textit{Top panel}: the distance of first apocentre passage from the centre of the galaxy for each kick velocity that resulted in a settled SMBH. 
...
%Furthermore, it is important to ascertain that the distribution of stars does not drastically change after the times chosen as the focus of the analysis. 
...
\begin{figure}
    ...
    \caption{
        ...
        At radii $r>3\,\mathrm{kpc}$ all the density profiles are consistent with each other, indicating that a changing SMBH recoil velocity has a larger impact on the inner mass distribution of the galaxy merger remnant.
        }
    \label{fig:density3d}
\end{figure}
...
The $\vk=2000\,\kmps$ simulation, in which the SMBH does not oscillate through the core, has a central stellar density that decreases only due to the initial response of the stellar particles to the suddenly-changed potential.
...
\begin{figure}
    ...
    \caption{
        ...
        \textit{Bottom panel}: Mass deficit $M_\mathrm{def}$ between S\'ersic and core-S\'ersic fits as a function of the recoil velocity scaled to the mass deficit due to SMBH binary scouring ($M_{\mathrm{def},0}$, left axis) and physical units (right axis). 
        }
    \label{fig:vkrb}
\end{figure}
...
An excellent introduction to Bayesian data analysis, and in particular hierarchical modelling, can be found in \citet{gelman2015}, which we summarise in \autoref{sec:app_fit} of the Appendix in the context of our work.
...
%Past studies have found the mass deficit to be proportional to the mass of the binary approximately $M_{\mathrm{def}}\sim 0.5 -- 5 M_{BH}$ for a single merger. 
...
\begin{equation}
    M_{\mathrm{def}}=2\pi \Upsilon \int_0^\infty \left[ \Sigma_{\mathrm{s}}(R)-\Sigma(R)\right] R \dd{R},
\end{equation}
where the mass-to-light ratio is chosen to be $\Upsilon=3.5 \, \Msun / \Lsun$ \citep{bonfini2016}. The core-S\'ersic profile is calculated using \autoref{eq:cs} and \autoref{eq:cs_prefactor}, while the S\'ersic profile can be obtained using the same set of equations with a slight modification. 
By setting $\rb = 0$ in \autoref{eq:cs}, the profile becomes the standard S\'ersic profile:
\begin{equation}
    \Sigma_{\mathrm{s}} = \Sigma ' \exp \left( -b_n (R/R_{\mathrm{e}})^{1/n} \right).
\end{equation}
...
The mass deficits as a function of kick velocities $\vk\leq 1020\,\kmps$ are shown in the lower panel of \autoref{fig:vkrb}. At low kick velocities, $\vk\leq 240\,\kmps$, we see a slow monotonic increase of mass deficit as a function of the kick velocity. Although the scatter grows at higher kick velocities, an increase of the median trend can be observed over the whole kick velocity range.
For high $\vk$ we see a median trend of $M_\mathrm{def} \sim 3 M_{\mathrm{def},0}$, where $M_{\mathrm{def},0}$ corresponds to the mass deficit from binary scouring alone. We find that the median mass deficit due to SMBH binary scouring prior to the coalescence of the SMBHs is $M_{\mathrm{def},0}=5.11\times10^9\,\Msun$, roughly $0.87M_\bullet$.
As a consequence of the mass deficit growing to $M_\mathrm{def} > M_\bullet$ for non-zero recoil velocities, as well as higher recoil velocities resulting in larger $M_\mathrm{def}$, we confirm our earlier hypothesis in \autoref{ssec:movement} that stellar mass bound to the SMBH (at most $0.37M_\bullet$) is not the primary mechanism by which the core grows.

Although \citet{merritt2006} and \citet{nasim2021b} found smaller mass deficit values from binary scouring alone for single mergers ($M_{\mathrm{def},0}\simeq 0.5\, M_\bullet$ and $M_{\mathrm{def},0}\simeq 0.26\,M_\bullet$, respectively), our value is in agreement with other previous studies. \citet{gualandris2008} reported a $M_{\mathrm{def},0}\sim M_\bullet$ relation, which is comparable to our value. In addition, similar mass deficits have also been found by \citet{rantala2024}. Slight discrepancies can be attributed to the differences in initial conditions and to varying approaches to computing mass deficits. Additionally, \citet{gualandris2008} use 3D density profiles, while we utilise projected profiles to make our results more comparable to observational data.

%\citet{merritt2006} found
%Although slightly smaller, our value is in good agreement with 26 per cent from the first generation equal mass merger of \citet{nasim2021b} (see merger `A1' in their Table 4). Slight differences can be attributed to the differences in initial conditions.

%\citet{merritt2006} and \citet{gualandris2008} found larger mass deficit values from binary scouring alone for single mergers: $M_{\mathrm{def},0}\simeq 0.5\, M_\bullet$ and $M_{\mathrm{def},0}\sim M_\bullet$, respectively) \sonja{Should I add Rantala2024 $M_{\mathrm{def},0}\sim (0.75-2)\, M_\bullet$ to this list? Their approach to Mdef is very different.}. Although differing initial conditions already cause discrepancies of the missing mass values, varying approaches to computing mass deficits may also contribute to variations. Additionally, \citet{gualandris2008} use 3D density profiles, while we utilize projected profiles to make our results more comparable to observational data. 
...
Additionally, we note that the choice of the value of the mass-to-light ratio impacts the resulting mass deficits. For example, by using $\Upsilon=4.5 \, \Msun / \Lsun$ (instead of $\Upsilon=3.5 \, \Msun / \Lsun$) the value of the binary scouring alone increases to $\sim 112$ per cent of the total SMBH binary mass.
...
For example, in the case of the sigmoid model, a normalised recoil velocity of $v'=2 \rightarrow \rb=3.9$, whereas $v'=4 \rightarrow \rb=4.0$.
...
Following \citet{frigo2021}, the expansion is limited to $n_\mathrm{max}=18$ and $l_\mathrm{max}=7$, as this sufficiently captures the potential of the galactic merger remnant.
...
This provides us with a potential field without the SMBH contribution; the potential from the SMBH is added as a point-mass potential following the SCF potential construction.
...
There is evidence for a minor decrease in outer $x$-tube orbits with increasing recoil velocity at radii, however this trend is not as dramatic as the three previously discussed.
...
We find that our galaxies have $\lambda_R<0.02$ within the IFU aperture, and thus we conclude very little rotation is present.
...
An ergodic system is one where $\sigma_{\theta}=\sigma_{\phi}=\sigma_r \iff \beta=0$, which thus describes a system where there is a balance between box and tube orbits.
...
Additionally, we find that this oscillatory motion, by the time the SMBH has settled, increases the stellar density core beyond that induced by the scouring of the SMBH binary prior to coalescence, confirming the results of \citet{gualandris2008}, \citet{nasim2021b}, and \citet{khonji2024}.
...
\citet{gualandris2008} found that each oscillation the SMBH enlarges the core, whereas \citet{nasim2021b} found that only the initial oscillation due to the recoil kick affects the core. 
...
All simulations with $\vk<1020\,\kmps$ display a core in projection however, in alignment with previous observational and theoretical work \citep[e.g.][]{ferrarese1994,nakano1999}.
...
However, we find that the excess of $\pi$-box orbits in the $\vk=2000\,\kmps$ simulation primarily originate from angular momentum conserving orbits (63\%) which have reacted to a sudden change in potential due to the escaping SMBH.
...
%What we can do though is assess how our simulated core sizes compare to observed core sizes.
...
Whilst exploring the full parameter space is beyond the scope of this work, using the methodology developed here and applying it to a statistically significant sample of galaxy mergers from cosmological simulations would be an interesting future avenue of investigation.
...
\begin{enumerate}
    ...
    \item An increase in the recoil velocity induces a larger core in the projected stellar mass density of the merger remnant than low recoil velocities, with our models indicating that core radii exceeding $1\,\mathrm{kpc}$ are not only possible, but likely.
...
We thank Jens Thomas for useful discussions on IFU observations.
\alex{\textbf{Everyone: please add your acknowledgements here}}
A.R. acknowledges the support by the University of Helsinki Research Foundation.
M.M., P.H.J., and D.I. acknowledge the support by the European Research Council via ERC Consolidator Grant KETJU (no. 818930).
...
P.H.J acknowledges the support of the Academy of Finland grant 339127.
...
\textbf{PHJ}: writing: original, supervision, funding acquisition.
...
We take all stellar particles within a fraction of the virial radius $R_\mathrm{vir}$, defined as the radius at which the mean density is equal to 200 times greater than the critical density; the virial radius is $\sim450\,\mathrm{kpc}$ for the merger remnants in this study.
...
\end{equation}
and $c\leq b\leq a$. 
The tensor $\tilde{I}_\mathrm{red}$ is determined by binning the stellar component of the remnant into 20 radial shells from $10^{-3} R_\mathrm{vir}$ to $10^{-1} R_\mathrm{vir}$: the binning of particles is not cumulative. 
...
One case worth a special mention is the width of the 25\% HDI for the parameter $\alpha$.
...
\begin{figure*}
    ...
    \caption{
        ...
        Contours indicate, from dark to light blue, the 25\%, 50\%, 75\%, and 99\% highest density intervals (HDIs).
