...
There is much evidence for the presence of supermassive black holes (SMBHs) at the centres of massive galaxies, with the shadow of one such SMBH being directly imaged.
...
First, as the galaxies begin to dynamically interact and the SMBHs traverse through a dense stellar field, the overdensity of stars in the wakes of the SMBHs provides a restoring force which brings the SMBHs to the centre of the two interacting galaxies, generally torquing the SMBHs to highly radial orbits in the process. 
Second, after the SMBHs have formed a bound binary, iterative interactions with the surrounding stars ejects stars with high velocity, thus removing orbital energy and angular momentum from the SMBH binary orbit.
...
Due to the anisotropic emission of the final GW emission \drafting{during? following?} coalescence, the remnant SMBH recoils with some velocity, termed the kick velocity. 
...
Previous studies \drafting{reference} indicate that while the majority of recoil kicks are of the order of a few hundred kilometres per second, in special configurations the SMBH may have an imparted kick velocity in excess of $4000\,\kmps$ \drafting{references}.
Taking the central escape velocity of a typical early type galaxy (ETG) as $\sim2000\,\kmps$, there may be a non-negligible fraction of ETGs with a SMBH that has escaped the galaxy.
In cases where the kick velocity is less than the escape velocity of the inner regions of the host galaxy, the radial oscillations of the remnant SMBH as it returns to the centre of the merger remnant is expected to influence the surrounding stellar environment. 
...
We model the merger of two gas-free elliptical galaxies using collisionless merger simulations.
