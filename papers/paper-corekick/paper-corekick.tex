...
We create velocity vector fields of the stellar particle motion in the $x$-$y$ plane \drafting{see Appendix}.
...
The IFU maps describe the line of sight velocity distribution, thus the motion along the $x$-axis in \drafting{figure} is equivalent to the parallel projection, and the $y$-axis equivalent to the orthogonal projection previously described in \autoref{ssec:ifu}.
