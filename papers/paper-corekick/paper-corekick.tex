...
\begin{figure}
    ...
    \caption{Probability density function of core radius, where kick velocity is MC sampled from Zlochower relation, and pumped through our fitted model in \autoref{eq:vkrb}.}
    \label{fig:rb_pdf}
\end{figure}
