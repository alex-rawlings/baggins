...
\begin{figure*}
    \centering
    \includegraphics[width=\textwidth]{vk_rb}
    \caption{Relation and fit between core radius and kick velocity.}
    \label{fig:vkrb}
\end{figure*}
...
\begin{figure*}
    ...
    \caption{$h_4$ kinematic maps of pre-merger and select remnants, possible to observe signature of kick in here? (Thorsten believes yes...)}
    \label{fig:h4}
\end{figure*}
