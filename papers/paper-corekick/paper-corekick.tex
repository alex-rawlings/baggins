...
\begin{figure*}
    ...
    \caption{Directed acyclic graph of Bayesian hierarchical factor model.}
    \label{fig:dag}
\end{figure*}
...
\begin{figure*}
    \centering
    \includegraphics[width=\textwidth]{rb-kick}
    \caption{
        Bayesian estimate of the merger remnant core size $r_b$, scaled to the core size of the pre-merger remnant $r_{b,0}$, as a function of kick velocity $v_\mathrm{kick}$.
        The core size distributions are shown as violin plots, with the median core size indicated by a white circle, and the interquartile range by the box. 
...
\begin{figure*}
    \centering
    \includegraphics[width=\textwidth]{rb_pdf}
    \caption{Probability density function of core radius, where kick velocity is MC sampled from Zlochower relation, and pumped through our fitted model in \autoref{fig:vrkb}.}
    \label{fig:rb_pdf}
\end{figure*}
...
\begin{figure*}
    ...
    \caption{
        Mock integral field unit kinematic maps of the $v_\mathrm{kick}=0\,\kmps$ remnant, plotted out to $0.5\,\Reff$. 
...
\begin{figure*}
    \centering
    \includegraphics[width=\textwidth]{IFU_v0960}
    \caption{
        Mock integral field unit kinematic maps of the $v_\mathrm{kick}=960\,\kmps$ remnant, again plotted out to $0.5\,\Reff$. 
        Contrasting to the $v_\mathrm{kick}=0\,\kmps$ case in \autoref{fig:IFU0}, this IFU map has a much greater extent of $h_4<0$ that also reaches more extreme values of $h_4$ \drafting{check this}. 
    }
    \label{fig:IFU960}
\end{figure*}
...
\begin{figure*}
    ...
    \caption{
        ...
        Immediately apparent is the decrease in $\langle h_4 \rangle$ with increasing $v_\mathrm{kick}$.
...
\appendix
\section{Core-Se\'rsic fit parameter estimates}
\drafting{Let's put the violin plots for all core fit parameters in the appendix}.
