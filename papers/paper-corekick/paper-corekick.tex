...
\begin{figure}
    ...
    \caption{
        ...
        A clear dichotomy is revealed in the mass profiles, whereby high kick velocities induce a core, and low kick velocities do not, with a sudden transition at $\vk=540\,\kmps$.
        }
    \label{fig:density3d}
\end{figure}
...
We create velocity vector fields of the stellar particle motion in the $x$-$y$ plane (see \autoref{fig:wake}).
...
The velocity fields are created for particles in a rectangular box defined by $0\leq x/\mathrm{kpc}$, $-5\leq y/\mathrm{kpc}\leq 5$, and $-5\leq z/\mathrm{kpc}\leq 5$, as described in \autoref{sec:discussion}, and are shown in \autoref{fig:wake}.
