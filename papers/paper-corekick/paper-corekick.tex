...
In \autoref{fig:density3d}, we observe a clear dichotomy in the 3D spatial distribution of stellar mass, with mergers that had an SMBH with a kick velocity $\vk<540\,\kmps$ having more mass in the central $2\,\mathrm{kpc}$ than those mergers with $\vk>540\,\kmps$. 
...
The first and most important, is the complete absence of Keplerian orbits for all simulations with $\vk>600\,\kmps$.
Conversely, all simulations with $\vk<600\,\kmps$ (except for $\vk=540\,\kmps$) have more than $\sim25\%$ of the orbits in the innermost radial bin being identified as Keplerian. 
...
\drafting{
    ...
    \begin{itemize}
        ...
        \item The presence of Keplerian orbits. 
    \end{itemize}
    What is going on? 
