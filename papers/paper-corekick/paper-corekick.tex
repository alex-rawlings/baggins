...
\begin{figure}
    ...
    The SMBH kick velocity is Monte Carlo sampled from the \citet{zlochower2015} relation assuming randomly-aligned azimuthal spins, and pushed through each of the three fitted model in \autoref{eq:vkrb} \drafting{add other models}. 
...
\begin{figure}
    ...
    \caption{
        ...
        Lines terminating with a circle point indicate simulations with $\vk/\kmps < 600$, those with square points indicate simulations with $600 \leq \vk/\kmps < 1200$, and the diamond point indicates the $\vk=2000\,\kmps$ simulation.
