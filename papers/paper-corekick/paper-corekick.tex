...
\drafting{Need to edit all this, \textbf{Atte} could you do this seeing as you've chosen the snapshots?
...
\drafting{
    ...
    \begin{enumerate}
        ...
        \item Number of oscillations before settling, probably on the same plot but as a second y axis?
        \item Plot of apocentre of kicked BH as a function of kick velocity. How does this compare to core size? Which simulations have BH kicked beyond the core? Can fit a function to data maybe
        \item Langrangian radii: how is the stellar mass moving about? 
    \end{enumerate}
}
\drafting{
...
\begin{figure}
    \centering
    \includegraphics[width=0.4\textwidth]{infall_apo}
    \caption{Plot of infall time (time to stability criterion) as a function of kick velocity, and number of oscillations. Maybe can do apocentre plot too: make this a 2x1 figure??}
    \label{fig:infall}
\end{figure}
\begin{figure}
    \centering
    \includegraphics[width=0.4\textwidth]{lagrangian}
    \caption{Plot of Lagragian radii: comment on matter movement}
    \label{fig:max_disp}
\end{figure}
...
\begin{figure}
    \centering
    \includegraphics[width=0.5\textwidth]{anisotropy_profiles_std_log}
    \caption{
        \drafting{\textbf{Max contribution} Put here for now, a better spot elsewhere? Also need to update caption and include in text.}
        Stellar velocity anisotropy parameter $\beta$ as a function of radius for the galaxy mergers with kick velocities between $0\,\kmps$ and $2000\,\kmps$. 
        The stellar particles are divided into 20 logarithmic bins between $0.1\,\mathrm{kpc}$ and $20\,\mathrm{kpc}$.
        The dotted horizontal line indicates $\beta=0$. 
    }
    \label{fig:beta}
\end{figure}
