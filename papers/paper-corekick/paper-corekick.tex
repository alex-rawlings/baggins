...
The relaxation time increases exponentially with increasing $r$, and we find for a radius of $r=0.1\,\mathrm{kpc}$ the relaxation time to be $t_\mathrm{relax} \sim 0.1 \, \mathrm{Gyr}$, thus motivating our choice of $0.075\,\mathrm{Gyr}$ for the analysis time. 
