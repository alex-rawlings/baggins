...
\drafting{We then construct isolated merger initial conditions}. 
Interactions between stellar particles are softened with a softening length of \drafting{$\varepsilon = 2.5\,\mathrm{pc}$, and the \ketju{} region radius is set to $r_{\rm ketju}=3\varepsilon = 7.5\,\mathrm{pc}$.}
