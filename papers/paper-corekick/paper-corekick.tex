...
We fit the model with \textsc{Stan} using the No U-turn sampler (NUTS, a variant of Hamiltonian Monte Carlo) with four chains each of 4000 iterations, of which the first 2000 are discarded as warmup.
