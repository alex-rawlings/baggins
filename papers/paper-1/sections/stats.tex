...
In this work, we have eight mass resolution families, with each family containing ten realisations of the same initial state. 
...
Choosing a truncated normal or gamma distribution with support on $[0,\infty)$ would represent a physically-motivated choice for the prior distribution here. 
...
\drafting{Now using LOO method. Which section should this go in? Relation to HDI?}
