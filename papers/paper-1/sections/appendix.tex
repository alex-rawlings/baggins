...
\begin{figure*}
    \includegraphics{{graham_density-H-H-3.0-0.001_gqs_prior}.pdf}
...
\begin{figure*}
    \includegraphics{{graham_density-H-H-3.0-0.001_prior_pred_log10_proj_density_mean}.pdf}
...
\begin{figure*}
    \includegraphics{{graham_density-H-H-3.0-0.001_pair_0}.pdf}
...
\begin{figure*}
    \includegraphics{{graham_density-H-H-3.0-0.001_pair_1}.pdf}
    \caption{\drafting{Same as \autoref{fig:corner_params_1}}}
    \label{fig:corner_params_2}
\end{figure*}

\begin{figure*}
    \includegraphics{{graham_density-H-H-3.0-0.001_pair_2}.pdf}
    \caption{\drafting{Same as \autoref{fig:corner_params_1}}}
