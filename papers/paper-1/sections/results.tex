...
\begin{figure*}
    \includegraphics[width=0.7\textwidth]{{graham_density-H-H-3.0-0.001_posterior_pred_log10_proj_density_mean}.png}
...
\begin{figure*}
    \includegraphics{compare_HH_gqs_res.png}
    \caption{\drafting{Comparison of core sersic fit for different mass resolutions. Note the scatter does not seem to decrease with increasing mass resolution, however the distribution modes seem to converge towards something. y-axes should read PDF}}
