...
For each simulation in a given set, we determine the mean eccentricity $e_\mathrm{h}$ over a \drafting{X Myr} time window after the SMBH binary has become hard.
