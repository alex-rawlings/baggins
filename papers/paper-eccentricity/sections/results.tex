...
\begin{figure*}
    ...
    \caption{\drafting{Inverse modelling convergence of eccentricity scatter as a function of mass resolution for $e_0=0.90$. NOTE AXIS LABEL SHOULD BE MASS RESOLUTION NOT PARTICLE NUMBER HERE}}
    \label{fig:nasim_e90}
\end{figure*}
