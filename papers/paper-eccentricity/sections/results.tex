...
\begin{figure*}
    ...
    \caption{\drafting{Inverse modelling convergence of eccentricity scatter as a function of mass resolution for $e_0=0.90$. }}
    \label{fig:nasim_e90}
\end{figure*}
We show the dependence of eccentricity standard deviation on mass resolution for the $e_0=0.90$ orbit in \autoref{fig:nasim_e99}. 
Immediately apparent is the lack of convergence of $\sigma_e$, with $5\times10^3$ and $1\times10^4$ mass resolutions demonstrating an increased scatter compared to the lowest mass resolution of $2.5\times10^3$.
...
This one outlier for each of the two resolutions artificially inflates the measured eccentricity variance, and by removing these two points we recover the $1/\sqrt{N_\star}$ scaling of $\sigma_e$ as in \citet{nasim20}.
However, these low eccentricity values are a valid measurement from the simulation, and highlight the weakness in the inverse modelling approach to determine the spread in eccentricity. 
The cause of these low eccentricity values is discussed in \autoref{ssec:toy}.
\drafting{Run Bayesian model, more robust?}
...
\drafting{TODO: figure comparing different eccentricity scatters}

\begin{figure*}
    \includegraphics{nasim_scatter_res-2M.pdf}
    \caption{\drafting{Inverse modelling of eccentricity scatter as a function of initial eccentricity for $M_\bullet/m_star=2\times10^4$. }}
