...
\title[Reviving Stochasticity]{Reviving stochasticity: SMBH-binary eccentricity is inherently random}

% The list of authors, and the short list which is used in the headers.
% If you need two or more lines of authors, add an extra line using \newauthor
\author[A. Rawlings et al.]{
Alexander Rawlings,$^{1}$\thanks{E-mail: alexander.rawlings@helsinki.fi}
Matias Mannerkoski,$^{1}$
Others,$^{1}$
\\
...
\textit{Software:} \ketju{} \citep{rantala17}, \gadget{} \citep{springel22}, NumPy \citep{numpy}, SciPy \citep{scipy}, Matplotlib \citep{matplotlib}, pygad \citep{rottgers20}. 
