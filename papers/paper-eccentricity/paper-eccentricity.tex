...
\textit{Software:} \ketju{} \citep{rantala17}, \gadget{} \citep{springel22}, \textsc{Stan} \citep{carpenter17}, NumPy \citep{numpy}, SciPy \citep{scipy}, Matplotlib \citep{matplotlib}, pygad \citep{rottgers20}, Arviz \citep{arviz}. 
