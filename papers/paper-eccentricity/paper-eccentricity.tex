...
depending on comparatively tiny differences on the scale of a parsec in the exact realization of the galactic merger orbit.
On the other hand, in minor mergers where there is less asymmetry in the stellar background when the SMBHs become bound,
the scatter in eccentricity is likely to be low even in the case of a radial merger orbit, since the system is no longer sensitive to the exact value of the deflection angle,
...
since the relevant dynamics occurs within few hundred parsecs from the center of the merged galaxy,
...
and the dynamical friction from the dark matter halo would generally drive even lower eccentricity merger orbits to highly radial final plunges.
...
The SMBHs are likely also not located exactly at the center of mass of the galaxy,
...
By using a resolution-free toy model of the SMBH scattering process,
