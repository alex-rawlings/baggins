...
Firstly, dynamical friction \citep{chandrasekhar1943}, acts to bring the SMBHs from kiloparsec-scale separations to parsec-scale separations, after which the SMBHs form a bound binary with a semimajor axis $a$ and eccentricity $e$ \citep[e.g.][]{Merritt2013book}. In the second phase, the
...
SMBHs to coalescence \citep[e.g.][]{Mannerkoski2019,Mannerkoski2021,Mannerkoski2022}, where the strength of GW emission strongly depends on the
