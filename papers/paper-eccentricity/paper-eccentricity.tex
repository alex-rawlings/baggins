...
and we find $\ln{\Lambda} = 4.7$ to give results that agree well with the simulations.
...
although the model does appear to capture the mean behaviour fairly well, apart from the largest values of
$\theta_\mathrm{defl}$.
