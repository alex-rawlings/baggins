...
Otherwise the behavior of the simulation data is captured well,
...
Together with the simple toy model that reproduces well the behavior seen in the simulations,
...
depending on comparatively tiny differences on the scale of a parsec in the particular realization of the galactic merger orbit.
\drafting{
    This observation is at odds with \citet{nasim2021}, where binaries that formed at high eccentricity tended to proceed to higher eccentricities.
    However, the tension can be explained if the simulations of \citet{nasim2021} lie in the linear region of the $\theta_\mathrm{defl}$--$e_\mathrm{h}$ parameter space (where most of the simulations in this work lie), coupled with the low-number statistics of \citet{nasim2021}.
    This would suggest that the potential of the merger remnant, as opposed to the rotation of the SMBH binary relative to the stellar background, is the dominant predictor of hard binary eccentricity.
}
...
The simulation setup used in this work is highly idealized,
...
However, most major mergers are expected to occur on highly radial orbits based in cosmological simulations \citep[e.g.][]{khochfar2006},
...
In numerical simulations with a discretised phase space, the two primary causes of variation in the impact parameter are the initial particle sampling variation in the merger initial conditions and the Brownian motion of the SMBH binary \citep{merritt2001}.
