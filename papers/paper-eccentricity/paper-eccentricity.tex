...
deflection angle $\theta$ during the binary formation,
...
For dynamical friction, we use the \citet{1943ApJ....97..255C} formula assuming
a Maxwellian distribution with a constant velocity dispersion $\sigma$ \citep[e.g.][]{binney2008}.
...
On the other hand, if the model is run with low values of $e_\mathrm{s}$,
the binary always reaches extremely high eccentricities with little dependence on the deflection angle,
indicating that the asymmetry of the galactic potential during the SMBH binary formation is the cause for the observed eccentricity behavior.
