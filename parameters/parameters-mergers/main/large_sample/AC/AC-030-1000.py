...
#--- perturb properties
seed = 982541                       #seed for setting the RNG
perturbTime = 7.304                 #time when BH positions are perturbed
...
#----------------------------------returned values
e = 7.03114e-01
full_save_location = "/scratch/pjohanss/arawling/collisionless_merger/mergers/A-C-3.0-1.0"
r0 = 1.68594e+03
rperi = 5.61981e+02
time_to_pericenter = 2.78693e+00
virial_radius = 5.61981e+02
#----------------------
perturb_snap_idx = -1.00000e+00
#----------------------
