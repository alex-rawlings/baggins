...
perturbTime = 6.111                 #time when BH positions are perturbed
...
#----------------------------------returned values
e = 9.75649e-01
full_save_location = "/scratch/pjohanss/arawling/collisionless_merger/mergers/C-D-3.0-0.1"
r0 = 1.68594e+03
rperi = 5.61981e+01
time_to_pericenter = 2.13172e+00
virial_radius = 5.61981e+02
#----------------------
perturb_snap_idx = 6.20000e+01
#----------------------
