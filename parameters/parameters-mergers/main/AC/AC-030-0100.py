...
perturbTime = 5.016                 #time when BH positions are perturbed
...
#----------------------------------returned values
e = 9.75649e-01
full_save_location = "/scratch/pjohanss/arawling/collisionless_merger/mergers/A-C-3.0-0.1"
r0 = 1.68594e+03
rperi = 5.61981e+01
time_to_pericenter = 1.84055e+00
virial_radius = 5.61981e+02
#----------------------
perturb_snap_idx = 5.10000e+01
#----------------------
