...
perturbTime = 5.071                 #time when BH positions are perturbed
...
#----------------------------------returned values
e = 9.91681e-01
full_save_location = "/scratch/pjohanss/arawling/collisionless_merger/mergers/A-C-3.0-0.05"
r0 = 1.68594e+03
rperi = 2.80991e+01
time_to_pericenter = 1.71071e+00
