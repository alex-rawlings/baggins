...
|-----|--|--|--|--|--|--|--|--|--|--|
|0.001|A |c |c |w |A |A |A |w |C |C |
|0.005|A |c |C |w |A |A |A |w |C |C |
|0.010|A |c |C |w |A |A |A |w |C |C |
|0.050|A |c |c |w |A |A |A |w |C |C |
|0.100|A |c |C |w |A |A |A |w |C |C |
|1.000|A |p |p |w |A |A |A |p |C |C |
...
|AC-3.0-0.010 | . | . | x | x | . | o | . | x | x | o |   2 |
|AC-3.0-0.050 | . | . | o | x | o | x | x | o | x | . |   3 |
...
|AD-3.0-0.050 | o | . | x | x | x | x | o | x | x | x>|   2 |
